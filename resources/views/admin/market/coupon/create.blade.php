...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section>
            <form action="{{ route('admin.market.coupons.store') }}" method="post" id="form">
                @csrf
                <section class="row">
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   name="discount_ceiling" id="discount_ceiling" value="{{ old('discount_ceiling') }}">
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="amount_type" id="amount_type"
                                ...
                                <option value="1" @selected(old('amount_type') == 1)>تومان</option>
                            </select>
                        </div>
                    </section>
