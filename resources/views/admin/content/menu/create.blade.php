...
@section('content')
    ...
    <section class="main-body-container">
        ...
        <section>
            <form action="{{ route('admin.content.menus.store') }}" method="post" id="form">
                @csrf
                <section class="row">
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="parent_id" class="font-weight-bold">منو والد</label>
                            @error('parent_id')
                            <span class="alert_required text-danger" role="alert">
                                    <small>
                                        <b>{{ $message }}</b>
                            ...
                            <select name="parent_id" id="parent_id"
                                ...
                                @forelse($parentMenus as $parentMenu)
                                    <option @selected( old('parent_id')  === $parentMenu->id)
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="url"
                                   ...
                                   name="url" value="{{ old('url') }}" placeholder="مثال: example.com">
                        </div>
                    </section>
