                ...
                <section class="row">
                            ...
                            <select name="brand_id" id="brand_id"
                                ...
                                @forelse($brands as $brand)
                                    <option value="{{ $brand->id }}"
                                        @selected( old('brand_id') == $brand->id)>{{ $brand->persian_name }}</option>
                                @empty @endforelse
                            </select>
                        </div>
                    </section>
                    ...
                    <section class="col-12 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   class="form-control form-control-sm @error('price') border border-danger @enderror"
                                   name="marketable_number" id="marketable_number" value="{{ old('marketable_number') }}">
                        </div>
                    </section>
                            ...
                            <section class="row border-right border-top radius-05t border-left p-2">
                                <section class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <input type="text"
                                               class="form-control form-control-sm @error('weight') border border-danger @enderror"
                                ...
                                <section class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <input type="text"
                                               class="form-control form-control-sm @error('length') border border-danger @enderror"
