...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 p-0"><a href="{{ route('admin.content.comments.index') }}">نظرات</a>
            </li>
    ...
    <section class="main-body-container">
        ...
        <section class="body-content d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
            <a href="{{ route('admin.content.comments.index') }}"
            ...
            <section class="card-body">
                <section class="d-flex justify-content-between">
                    <h5 class="card-title"><b>عنوان پست :</b>
                        <a href="{{ route('admin.content.posts.show', $comment->commentable) }}"
                           class="show-link"> {{ $comment->commentable->title }} </a>
                    </h5>
