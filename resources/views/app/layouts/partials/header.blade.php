    ...
    <section class="top-header">
        <section class="container-xxl ">
            <section class="d-md-flex justify-content-md-between align-items-md-center py-3">
                    ...
                    <section class="mt-3 mt-md-auto text-end">
                        <section class="d-inline px-md-3">
                            ...
                            <section class="dropdown-menu dropdown-menu-end custom-drop-down"
                                ...
                                <section><a class="dropdown-item" href="{{ route('profile.my-address.index')  }}"><i
                            ...
                            <a class="btn btn-link position-relative text-dark header-cart-link"
                               href="javascript:void(0)">
                                <i class="fa fa-shopping-cart"></i> <span style="top: 80%;"
                                                                          class="position-absolute start-0 translate-middle badge rounded-pill bg-danger">{{ $cart?->cart_items_count ?? 0 }}</span>
                            </a>
                            <section class="header-cart-dropdown">
                                <section class="border-bottom d-flex justify-content-between p-2">
                                    <span class="text-muted">{{ $cart?->cart_items_count ?? 0 }} کالا</span>
                                    <a class="text-decoration-none text-info" href="{{ route('cart.') }}">مشاهده سبد
                                        خرید </a>
                                </section>
                                    ...
                                    @if($cart)
                                        @forelse($cart->cartItems as $cartItem)
                                            ...
                                            <section
                                                ...
                                                <img class="flex-shrink-1" src="{{ $cartItem->product->image }}" alt="">
                                                <section class="w-100 text-truncate"><a
                                                        class="text-decoration-none text-dark"
                                                        href="#">{{ $cartItem->product->name }}
                                                    </a></section>
                                            </section>
                ...
                @endauth
                @guest
                    <a class="btn btn-danger btn-sm" href="{{ route('login') }}"><i
                            class="fas fa-sign-in-alt p-1"></i><span>ورود / ثبت نام</span>
                    </a>
                @endguest
            </section>
        </section>
            ...
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-start position-relative">
                    ...
                    @foreach ($productCategories as $productCategory)
                        <section class="navbar-item"><a href="#">{{ $productCategory->name }}</a></section>
                    @endforeach
